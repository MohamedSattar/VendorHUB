...
const documents: DocumentConfigExtended[] = [
  {
    ...
    tooltip:
      "Upload your professional curriculum vitae (CV) or resume documenting your work experience and qualifications",
  },
  {
    id: "introduction",
    ...
    tooltip:
      "Professional introduction letter highlighting your background, qualifications, and interest in the role",
  },
  {
    id: "education",
  ...
  },
  {
    ...
    tooltip:
      "Certificate or letter from your current/previous employer confirming your salary details",
  },
  {
    id: "passport",
    label: "Passport",
  ...
  },
  {
    ...
    tooltip:
      "Letter from your employer confirming your work experience and responsibilities",
  },
  {
    id: "police",
    ...
    tooltip:
      "Official police clearance certificate from your country of residence",
  },
];

const DocumentUploadSection = forwardRef<
...
>(function DocumentUploadSection(
  ...
  useImperativeHandle(
    ...
    () => ({
      areDocumentsValid: (uaeResidentValue: boolean | null) => {
        ...
        const emiratesIdValid =
          uaeResidentValue === true
  ...
  const handleDownloadTemplate = async () => {
    try {
      ...
      const template = data.value?.find(
        (item: any) =>
      ...
      if (template.prmtk_description) {
        ...
        const file = new Blob([template.prmtk_description], {
          type: "text/plain",
        });
