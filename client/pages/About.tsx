          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                <p className="text-gray-700 mb-2"><span className="font-semibold">{t("about.email")}</span> support@eca.gov.ae</p>
                <p className="text-gray-700"><span className="font-semibold">{t("about.hours")}</span> Sunday - Thursday, 8:00 AM - 5:00 PM (GST)</p>
              </div>
            </section>
          </div>
        </div>
