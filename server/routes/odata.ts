...
export const handleGetOpenRoleById: RequestHandler = async (req, res) => {
  try {
    ...
    const url =
      ...
      `$select=prmtk_candidateengagementnameid,prmtk_rolename,prmtk_startdate,prmtk_enddate,prmtk_status,prmtk_readyforsubmission,_prmtk_candidate_value,_prmtk_engagement_value,_prmtk_engagementcontact_value,prmtk_name,createdon,modifiedon,statuscode`;
...
export const handleGetOpenRoles: RequestHandler = async (req, res) => {
  try {
    ...
    const url =
      ...
      `$select=prmtk_candidateengagementnameid,prmtk_rolename,prmtk_startdate,prmtk_status,prmtk_readyforsubmission,_prmtk_candidate_value,_prmtk_engagementcontact_value,createdon,modifiedon,statuscode&` +
