...
export const handleGetOpenRoles: RequestHandler = async (req, res) => {
  try {
    ...
    const url =
      ...
      `$select=prmtk_candidateengagementnameid,prmtk_rolename,prmtk_startdate,prmtk_status,prmtk_readyforsubmission,_prmtk_candidate_value,prmtk_engagementcontactid,createdon,modifiedon,statuscode&` +
