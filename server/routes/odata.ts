...
export const handleGetEngagementById: RequestHandler = async (req, res) => {
  try {
    ...
    const url =
      ...
      `$select=prmtk_engagementid,prmtk_engagementname,prmtk_description,prmtk_startdate,prmtk_enddate,prmtk_status,_prmtk_ecaengagementmanager_value,_prmtk_vendor_value,prmtk_uniqueid,prmtk_contractdescription,prmtk_typeofengagement,createdon,modifiedon,statuscode`;
